...
# most of this file was updated from a standard template
# I changed it to do what I wanted using django documentation
# and course material from CS 2080 as we learned a bit of django there
# I also used ChatGPT to help me troubleshoot code syntax as interfacing with the
# sglite DB was a bit of a pain
